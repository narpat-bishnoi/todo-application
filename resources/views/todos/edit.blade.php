...
<div class="max-w-2xl mx-auto">
    <div class="bg-white shadow-md rounded-lg p-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-6">Edit Todo</h1>
        ...
        <form method="POST" action="{{ route('todos.update', $todo) }}">
            ...
            <div class="mb-4">
                ...
                >
                    <option value="open" {{ old('status', $todo->status) === 'open' ? 'selected' : '' }}>Open</option>
            ...
            <div class="mb-6">
                ...
                >
                    ...
                    @foreach($employees as $employee)
                        <option value="{{ $employee->id }}" {{ old('assigned_to', $todo->assigned_to) == $employee->id ? 'selected' : '' }}>
                            {{ $employee->name }}
                        </option>
                    @endforeach
                </select>
